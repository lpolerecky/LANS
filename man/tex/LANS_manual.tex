...
\input{core/LANS_fileorg}
\input{core/LANS_typical}
\input{extras/LANS_lesscommon}
\input{core/LANS_appearance}
\input{core/LANS_singledataset}
\input{core/LANS_metafileproc}
...
\input{extras/LANS_ext_image}	% done, nanosims data resampling refers to the supplement of Spataro et al. 2023
\input{extras/LANS_depth_var} % done
\input{extras/LANS_load8plus} % done
\input{extras/LANS_export_png} % done
\input{extras/LANS_export_tif} % done

% appendix

\input{core/LANS_appendix} % done
