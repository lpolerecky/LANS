function varargout = dtc_gui(varargin)
% DTC_GUI MATLAB code for dtc_gui.fig
%      DTC_GUI by itself, creates a new DTC_GUI or raises the
%      existing singleton*.
%
%      H = DTC_GUI returns the handle to a new DTC_GUI or the handle to
%      the existing singleton*.
%
%      DTC_GUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DTC_GUI.M with the given input arguments.
%
%      DTC_GUI('Property','Value',...) creates a new DTC_GUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before dtc_gui_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to dtc_gui_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help dtc_gui

% Last Modified by GUIDE v2.5 06-Jul-2011 16:34:10

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @dtc_gui_OpeningFcn, ...
                   'gui_OutputFcn',  @dtc_gui_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before dtc_gui is made visible.
function dtc_gui_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to dtc_gui (see VARARGIN)
...
set(handles.figure1,'Name','Dead-time correction settings');
fpos=get(handles.figure1,'Position');
%set(handles.figure1,'Position',[30 30 fpos(3:4)]);
...
% UIWAIT makes dtc_gui wait for user response (see UIRESUME)
uiwait(handles.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = dtc_gui_OutputFcn(hObject, eventdata, handles)
...
handles.output = handles.dtc_orig;
