...
%\input{extras/LANS_ext_image}	% mostly done, resampling of ext refers to the supplement of Spataro et al. 2023
%\input{extras/LANS_depth_var} % mostly done, results need to be updated
