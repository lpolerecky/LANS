...
A~copy of the supplement, as well as the related example data, can be downloaded from the same location as the LANS program (folder \ttt{test\_data/NS+TEM}). The datasets include the raw NanoSIMS data (\ttt{Spataro-3.im.zip}) and the corresponding TEM image (\ttt{Spataro-3\_TEM.tif}). 