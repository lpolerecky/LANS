...
\begin{tcolorbox}[sbox,
	title={\mbox{}\hfill Step~\thestep},
	attach boxed title to top left={xshift=-0.1\linewidth,yshift=-1.15\baselineskip},
       minipage boxed title=.06\linewidth,
	boxrule=0pt,
...
% step command
\newcommand\s[1]{\addtocounter{step}{1}\stepbox{#1}}
...
\begin{tcolorbox}[nbbox,
	title={Notes},
	attach boxed title to top left={xshift=-0.09\linewidth,yshift=-1.15\baselineskip},
       minipage boxed title=.05\linewidth,
	boxrule=0pt,
	leftrule=0.5mm, 
	left*=0pt, right*=0pt, %top=1mm, bottom=1mm, 
	boxsep=0\baselineskip,
...
\begin{tcolorbox}[nbbox,
	title={},
	attach boxed title to top left={xshift=-0.11\linewidth,yshift=-1.1\baselineskip},
